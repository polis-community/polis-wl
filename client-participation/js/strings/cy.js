...
s.importantCheckbox = "Mae'r sylw yma'n bwysig";
s.howImportantPrompt = "Pa mor bwysig ydi'r sylw yma?";
s.howImportantLow = "Llai";
s.howImportantMedium = "Canolig";
s.howImportantHigh = "Mwy";

s.modSpam = "Spam";
s.modOffTopic = "Amherthnasol";
s.modImportant = "Pwysig";
s.modSubmitInitialState = "Mynd heibio (dim o'r uchod), datganiad nesaf";
...
s.majorityOpinion = "Barn y Mwyafrif";
s.majorityOpinionShort = "Mwyafrif";
s.info = "Gwybodaeth";
...
s.helpWhatAmISeeingTitle = "Beth ydw i'n ei weld?";
s.helpWhatAmISeeing = "Mae'r bobl sy'n pleidleisio'r un ffordd wedi'u rhoi mewn grwpiau. Cliciwch grŵp i weld pa safbwyntiau maen nhw'n eu rhannu.";
s.helpWhatDoIDoTitle = "Beth ydw i'n ei wneud?";
s.helpWhatDoIDo = "Pleidleisiwch ar ddatganiadau pobl eraill trwy glicio 'cytuno' neu 'anghytuno'. Ysgrifennwch ddatganiad (cadwch bob un i un syniad). Gwahoddwch eich ffrindiau i'r sgwrs!";
s.writeCommentHelpText = "A yw eich safbwyntiau neu'ch profiadau ar goll o'r sgwrs? Os felly, <b> ychwanegwch nhw </b> yn y blwch isod.";
...
s.heresHowGroupVoted = "Dyma sut y pleidleisiodd Grŵp {{GROUP_NUMBER}}:";
s.one_person = "{{x}} unigolyn";
s.x_people = "{{x}} o bobl";
s.acrossAllPtpts = "Ar draws yr holl gyfranogwyr:";
s.xPtptsSawThisComment = " wedi gweld y datganiad hwn";
s.xOfThoseAgreed = "o'r cyfranogwyr hynny wedi cytuno";
s.xOfthoseDisagreed = "o'r cyfranogwyr hynny wedi anghytuno";
s.opinionGroups = "Grwpiau Barn";
s.topComments = "Datganiadau Blaenaf";
s.divisiveComments = "Datganiadau Cynhennus";
s.pctAgreed = "Cytunodd {{pct}}%";
s.pctDisagreed = "Anghytunodd {{pct}}%";
s.pctAgreedLong = "Cytunodd{{pct}}% o bawb sydd wedi pleidleisio ar ddatganiad {{comment_id}}.";
s.pctAgreedOfGroup = "Cytunodd {{pct}}% o Grŵp {{group}}.";
s.pctDisagreedOfGroup = "Anghytunodd {{pct}}% o Grŵp {{group}}.";
s.pctDisagreedLong = "Anghytunodd {{pct}}% o bawb sydd wedi pleidleisio ar ddatganiad {{comment_id}}.";
...
s.tipCommentsRandom = "Cofiwch, mae datganiadau yn cael eu harddangos ar hap ac nid ydych yn ymateb yn uniongyrchol i ddatganiadau cyfranwyr eraill.";
s.tipOneIdea = "Rhannwch ddatganiadau hir sy'n cynnwys mwy nag un syniad. Mae hyn yn ei gwneud hi'n haws i eraill bleidleisio ar eich datganiad.";
s.tipNoQuestions = "Ni ddylai datganiadau fod ar ffurf cwestiwn. Bydd cyfranwyr yn cytuno neu'n anghytuno â'r datganiadau a wnewch.";
s.commentTooLongByChars = "Mae'r datganiad rhy hir gan {{CHARACTERS_COUNT}} o lythrennau.";
s.notSentSinceDemo = "(ddim mewn gwirionedd, demo yw hwn)";
...
s.notificationsAlreadySubscribed = "Rydych chi wedi tanysgrifio i dderbyn diweddariadau ar gyfer y sgwrs hon.";
s.notificationsGetNotified = "Cewch eich hysbysu pan fydd mwy o ddatganiadau'n cyrraedd:";
s.notificationsEnterEmail = "Rhowch eich cyfeiriad e-bost i gael gwybod pan fydd mwy o ddatganiadau'n cyrraedd:";
s.labelEmail = "E-bost";
s.notificationsSubscribeButton = "Tanysgrifwch";
s.notificationsSubscribeErrorAlert = "Gwall wrth danysgrifo";
s.noCommentsYet = "Nid oes unrhyw ddatganiadau eto.";
s.noCommentsYetSoWrite = "Dechreuwch y sgwrs hon trwy ychwanegu datganiad.";
s.noCommentsYetSoInvite = "Dechreuwch y sgwrs hon trwy wahodd mwy o gyfranogwyr, neu ychwanegu datganiad.";
s.noCommentsYouVotedOnAll = "Rydych chi wedi pleidleisio ar yr holl ddatganiadau.";
s.noCommentsTryWritingOne = "Os oes gennych rywbeth i'w ychwanegu, ceisiwch ysgrifennu eich datganiad eich hun.";
s.convIsClosed = "Mae'r sgwrs hon ar gau.";
s.noMoreVotingAllowed = "Ni chaniateir pleidleisio pellach.";


s.topic_good_01 = "Beth ddylen ni ei wneud am yr ystafell pingpong?";
s.topic_good_01_reason = "penagored, gall unrhyw un gael barn ar atebion i'r cwestiwn hwn";
s.topic_good_02 = "Beth ydych chi'n ei feddwl am y cynnig newydd?";
s.topic_good_02_reason = "penagored, gall unrhyw un gael barn ar atebion i'r cwestiwn hwn";
s.topic_good_03 = "A allwch chi feddwl am unrhyw beth sy'n arafu'r gwaith?";

s.topic_bad_01 = "pawb i adrodd ar eich parodrwydd i lansio";
s.topic_bad_01_reason = "bydd pobl o wahanol dimau yn pleidleisio ar yr ymatebion, ond efallai na fydd ganddyn nhw ddigon o wybodaeth i bleidleisio'n hyderus.";
s.topic_bad_02 = "beth yw ein rhwystrau lansio?";
