...
s.helpWhatDoIDo = "Stem op andere standpunten door op 'akkoord', 'niet akkoord' of 'geen mening' te klikken. Schrijf een standpunt (blijf kort en bondig, één idee per lijn). Nodig vrienden uit om deel te nemen aan de dialoog!";
s.writeCommentHelpText = "<strong>schrijf</strong> een standpunt indien jouw mening niet wordt vertegenwoordigd</i>";
s.helpWriteListIntro = "Wat is een goede standpunt?";
...
s.pctAgreedLong = "{{pct}}% van iedereen wie stemden op standpunt {{comment_id}} waren akkoord.";
...
s.pctAgreedOfGroupLong = "{{pct}}% van de Groep {{group}} wie stemden op standpunt {{comment_id}} waren akkoord.";
s.pctDisagreedOfGroupLong = "{{pct}}% van de Groep {{group}} wie stemden op standpunt {{comment_id}} waren niet akkoord.";
s.commentSent = "Standpunt verzonden! Andere deelnemers zullen jouw standpunt zien en akkoord zijn of niet.";
...
s.tipNoQuestions = "Probeer vragen in jouw standpunten te vermijden. Deelnemers zullen vervolgens al dan niet akkoord gaan met jouw standpunt.";
