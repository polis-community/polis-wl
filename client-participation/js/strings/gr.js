...
s.participantHelpGroupsText = "Άτομα που ψηφίζουν παρόμοια <b>ομαδοποιούνται.</b> Πατήστε σε μία ομάδα για να δείτε ποιες απόψεις μοιράζονται. <a id='helpTextGroupsExpand'>...περισσότερα</a>";
