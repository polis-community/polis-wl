...
s.participantHelpGroupsText = "Люди, которые похоже голосуют <b>выделяются в группы.</b> Нажмите на группу, чтобы увидеть какие мнения их объединяют. <a id='helpTextGroupsExpand'>...больше</a>";
