...
module.exports = ConversationView.extend({
  ...
  context: function() {
    ...
    ctx.auth_opt_fb_computed = config.ENABLE_FACEBOOK && preload.firstConv.auth_opt_fb_computed;
    ctx.auth_opt_tw_computed = config.ENABLE_TWITTER && preload.firstConv.auth_opt_tw_computed;
